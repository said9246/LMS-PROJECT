      ...
      >
        <Menu iconShape="square">
          ...
          <Box paddingLeft={isCollapsed ? undefined : "10%"}>
            ...
            <Typography variant="h5" sx={{ m: "15px 0 5px 25px" }} className="!text-[18px] text-black dark:text-white capitalize !font-[400]">
              {!isCollapsed && "Data"}
            </Typography>

            <Item title="Users" to="/admin/users" icon={<Group />} selected={selected} setSelected={setSelected} />
            ...
            <Item title="Live Courses" to="/admin/courses" icon={<OndemandVideo />} selected={selected} setSelected={setSelected} />
            ...
            <Item title="Manage Teams" to="/admin/team" icon={<PeopleOutlined />} selected={selected} setSelected={setSelected} />
            ...
            <Item title="Logout" to="/" icon={<ExitToApp />} selected={selected} setSelected={setSelected} />
          </Box>
        </Menu> 
      </Sidebar>
    </Box>
